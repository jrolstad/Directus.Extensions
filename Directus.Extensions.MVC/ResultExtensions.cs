...
namespace Directus.Extensions.MVC
{
    public static class ResultExtensions
    {
        ...
        public static T Model<T>(this ViewResultBase result) where T : class
        {
            ...
            if (data == null) throw new ApplicationException(string.Format("Unable to cast from type {0} to {1}",result.Model.GetType(), typeof(T)));
        ...
        public static T Model<T>(this JsonResult result) where T : class
        {
            ...
            if (data == null) throw new ApplicationException(string.Format("Unable to cast from type {0} to {1}",result.Data.GetType(), typeof(T)));
